...
function selectpickerDirective($parse, $timeout) {
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      //## Merge das options defaults com o informado pelo usuario
      var optionsDefaults = { noneSelectedText: 'Selecione' };
      var options = $parse(attrs.selectpicker)();
      var settings = $.extend({}, optionsDefaults, options);
      //##
