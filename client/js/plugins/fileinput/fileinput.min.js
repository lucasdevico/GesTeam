...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'Arquivo "{name}" (<b>{size} KB</b>) é muito pequeno e deve ser maior que <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Arquivo "{name}" (<b>{size} KB</b>) excede o tamanho máximo de upload permitido de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Você deve selecionar pelo menos <b> {n} </ b> {arquivos} para carregar.',
        ...
        msgInvalidFileType: 'Tipo inválido para o arquivo "{name}". Somente arquivos "{types}" são suportados.',
        msgInvalidFileExtension: 'Extensão inválida para o arquivo "{name}". Somente arquivos "{extensions}" são suportados.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadEmpty: 'Não existem dados para upload.',
