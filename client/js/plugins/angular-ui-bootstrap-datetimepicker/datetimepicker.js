    ...
    function () {
      ...
      return {
        ...
        template: function (elem, attrs) {
          ...
          var dvInputGroup = "<div class=\"input-group input-group-sm date\">" +
            tmpl + buttonTrigger + "\n</div>\n";
          tmpl = dvInputGroup;
        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          //console.log(attrs.buttonTrigger);
          //console.log($(element).parent().find(attrs.buttonTrigger));

          var buttonTrigger = $(element).parent().find(attrs.buttonTrigger);
          buttonTrigger.click(function(){ scope.innerDateOpened = true; });
